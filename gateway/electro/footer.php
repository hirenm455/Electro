						...
						<div class="col-sm-4">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>MPSTME, Vileparle-West</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+91 98-7654-3210</a></li>
						...
						<div class="col-sm-4">
							<div class="footer">
								...
								<ul class="footer-links">
									...
									<li><a href="accessoris.php">Accessories</a></li>
								</ul>
							</div>
						</div>
