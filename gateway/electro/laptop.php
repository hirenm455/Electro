...
<?php include('container.php');?>
	...
	<div class="col-md-3">                    
		...
		<div class="list-group">
			...
			<div class="brandSection">
				...
				<label><input type="checkbox" class="productDetail brand" value="<?php echo $brandDetails["brand"]; ?>"  >
				 <?php echo $brandDetails["brand"]; ?></label>s
				</div>
				<?php }	?>
			</div>
		</div>
		...
		<div class="list-group">
			...
			?>
			<div class="list-group-item checkbox">
			<label><input type="checkbox" class="productDetail storage" value="<?php echo $storageDetails['storage1']; ?>"  > <?php echo $storageDetails['storage1']; ?> GB</label>
			</div>
			<?php
			}
			?> 
